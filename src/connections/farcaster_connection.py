...
class FarcasterConnection(BaseConnection):
    ...
    def validate_config(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if (
            not isinstance(config["timeline_read_count"], int)
            or config["timeline_read_count"] <= 0
        ):
        ...
        self.actions = {
            "get-latest-casts": Action(
                ...
                parameters=[
                    ...
                    ActionParameter(
                        ...
                        False,
                        int,
                        "Number of casts to read, defaults to 25, otherwise min(limit, 100)",
                    ),
                ],
            ...
            "post-cast": Action(
                ...
                parameters=[
                    ...
                    ActionParameter(
                        "embeds", False, List[str], "List of embeds, defaults to None"
                    ),
                    ActionParameter(
                        "channel_key", False, str, "Channel key, defaults to None"
                    ),
                ],
            ...
            "read-timeline": Action(
                ...
                parameters=[
                    ...
                    ActionParameter(
                        ...
                        False,
                        int,
                        "Number of casts to read from timeline, defaults to 100",
                    ),
                ],
            ...
            "requote-cast": Action(
                ...
                parameters=[
                    ActionParameter(
                        "cast_hash", True, str, "Hash of the cast to requote"
                    )
                ],
            ...
            "reply-to-cast": Action(
                ...
                parameters=[
                    ActionParameter(
                        ...
                        True,
                        int,
                        "Farcaster ID of the parent cast to reply to",
                    ),
                    ActionParameter(
                        "parent_hash", True, str, "Hash of the parent cast to reply to"
                    ),
                    ActionParameter("text", True, str, "Text content of the cast"),
                    ActionParameter(
                        "embeds", False, List[str], "List of embeds, defaults to None"
                    ...
                    ActionParameter(
                        ...
                        False,
                        str,
                        "Channel of the cast, defaults to None",
                    ),
                ],
            ...
            "get-cast-replies": Action(
                ...
                parameters=[
                    ActionParameter(
                        ...
                        True,
                        str,
                        "Hash of the thread to query for replies",
                    )
                ],
    ...
    def configure(self) -> bool:
        ...
        print(
            "2. Navigate to Settings page (click profile picture on top left, then the gear icon on top right)"
        )
    ...
    def get_latest_casts(
        self, fid: int, cursor: Optional[int] = None, limit: Optional[int] = 25
    ) -> IterableCastsResult:
        """Get the latest casts from a user"""
        logger.debug(
            f"Getting latest casts for {fid}, cursor: {cursor}, limit: {limit}"
        )
    ...
    def read_timeline(
        self, cursor: Optional[int] = None, limit: Optional[int] = 100
    ) -> IterableCastsResult:
